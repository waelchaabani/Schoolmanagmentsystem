        ...
        <div class="flex w-1/2 justify-center items-center bg-white">
            <form class="bg-white" action="loginToTheDashboard" method="POST">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" type="email" name="email" placeholder="Email Address"
                        required />
                </div>
                ...
                <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer"><a href="register">Create an account
                        !</a></span>
                <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer"><a href="password/reset">Forget Password
                        !</a></span>
            </form>
        </div>
    </div>
